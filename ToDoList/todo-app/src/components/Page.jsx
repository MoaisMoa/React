...
const Page = ( {page, onToggle, onDelete, getList, isInitalPage = false }) => {
    ...
    // initalData가 변경될 때 pageData 업데이트
    useEffect(() => {
    ...
    const handlePageRemove = (id) => {
        // 초기 페이지는 전달받은 onDelete사용
        if(isInitalPage && onDelete){
            onDelete(id)
            return
        }
